...
<c:if test="${renderContext.user.name == 'guest' or renderContext.editMode or renderContext.request.getAttribute('ce_preview') != null}">
    ...
    <template:addResources type="css" resources="joaFranceConnectButton.css"/>

    <template:addResources>
        <script>
            function connectToFranceConnect${fn:replace(currentNode.identifier, '-', '')}() {
                var popup = window.open('', "FranceConnect Authorization", "menubar=no,status=no,scrollbars=no,width=1145,height=725,modal=yes,alwaysRaised=yes");
                var xhr = new XMLHttpRequest();
                xhr.open('GET', '<c:url value="${url.base}${renderContext.site.home.path}"/>.connectToFranceConnectAction.do');
    ...
    <c:choose>
        <c:when test="${tagType eq 'button'}">
            <button class="joaFranceConnectConnector ${cssClass}"
                    type="button"
                    onclick="connectToFranceConnect${fn:replace(currentNode.identifier, '-', '')}()"
                    <c:if test="${not empty htmlId}"> id="${htmlId}"</c:if>
                    <c:if test="${renderContext.editMode}">disabled</c:if> >
                <c:choose>
                    <c:when test="${currentNode.properties['buttonColor'].string eq 'backgroundWhite'}">
                        <svg version="1.1" id="Calque_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                            ...
                            <g>
                                ...
                                <path style="fill:#034EA2;" d="M147.6,59.1c-1.1,0-2.3-0.3-3.2-1.2c-1-1-1.4-2.6-1.4-4.4c0-1.8,0.5-3.6,1.9-4.7c1-0.8,2.3-1,3.7-1
                                    ...
                                    C150.2,58.7,148.8,59.1,147.6,59.1"/>
                                ...
                                <path style="fill:#034EA2;" d="M181.1,57.9c-1.1-0.9-1.6-2.5-1.6-4.5s0.5-3.6,1.6-4.6c1-0.9,2.3-1.1,3.8-1.1
                                    c1.4,0,2.7,0.3,3.8,1.1c1.1,0.9,1.6,2.5,1.6,4.6c0,2.1-0.5,3.6-1.6,4.6c-1,0.9-2.4,1.1-3.8,1.1C183.5,59.1,182.2,58.8,181.1,57.9
                            ...
                            <g>
                                ...
                                <g>
                                    <path style="fill:#034EA2;" d="M48.2,3.4L17,21.4v36.1l31.3,18l31.3-18V21.4L48.2,3.4z M78.5,56.9L48.2,74.4L18,56.9V22L48.2,4.5
                                        L78.5,22V56.9z"/>
                                </g>
                                <polygon style="fill:#034EA2;" points="62.6,20.8 48.9,12.9 35.2,20.8 25.9,26.2 25.9,26.2 25.9,52.7 25.9,52.7 48.9,66
                                    71.9,52.7 71.9,52.7 71.9,26.2 71.9,26.2 		"/>
                                <g>
                                    <path style="fill:#034EA2;" d="M57.4,42c0.4,0,0.8-0.1,1.2,0c0.3,0.1,0.7,0.1,0.7,0.2c-0.1,0.6-1,0.8-1.4,1.3c-0.1,0-0.1,0-0.2,0
                                        c-0.2,0.2-0.1,0.5-0.3,0.5c-0.2-0.1-0.4,0-0.7,0.1c0.3,0.3,0.7,0.5,1.1,0.4c0.1,0,0.2,0.1,0.2,0.3c0,0,0.1,0,0.1-0.1
                                    ...
                                    <path style="fill:#FFFFFF;" d="M63,46.4c-0.2-0.4-0.5-0.7-0.8-1.1c-0.3-0.5-0.7-0.9-0.8-1.5c-0.2-0.6,0-1.1,0-1.7
                                        ...
                                        c0,0,0.1,0,0.1-0.1c0,0.1,0,0.1-0.1,0.1c-0.3,0.2-0.5,0.4-0.8,0.6c-0.1,0.1,0,0.1,0.1,0.1c0.4-0.2,0.6-0.5,0.9-0.6
                                        ...
                                        c-0.2-0.4-0.6-0.9-0.2-1.3c0.5-0.3,1.3-0.3,1.5-0.8C64.3,47.8,63.5,47.1,63,46.4z M59.9,42.8c-0.1,0.1,0.2,0.2,0.2,0.4
                    ...
                    <c:when test="${currentNode.properties['buttonColor'].string eq 'backgroundBlue'}">
                        <svg version="1.1" id="Calque_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                             width="283.5px" height="82.2px" viewBox="0 0 283.5 82.2" style="enable-background:new 0 0 283.5 82.2;" xml:space="preserve">
                            <g>
                            ...
                            <g>
                                ...
                                <path style="fill:#FFFFFF;" d="M147.6,58.5c-1.1,0-2.3-0.3-3.2-1.2c-1-1-1.4-2.6-1.4-4.4c0-1.8,0.5-3.6,1.9-4.7c1-0.8,2.3-1,3.7-1
                                    c0.8,0,1.7,0.1,2.7,0.2v1.9c-0.7-0.1-1.6-0.1-2.4-0.1c-2.4,0-3.4,1.2-3.4,3.8c0,2.3,0.9,3.8,2.9,3.8c0.9,0,2.1-0.3,3.1-0.6v1.8
                                    C150.2,58.2,148.8,58.5,147.6,58.5"/>
                                ...
                                <path style="fill:#FFFFFF;" d="M181.1,57.4c-1.1-0.9-1.6-2.5-1.6-4.6s0.5-3.6,1.6-4.6c1-0.9,2.3-1.1,3.8-1.1
                                    c1.4,0,2.7,0.3,3.8,1.1c1.1,0.9,1.6,2.5,1.6,4.5c0,2.1-0.5,3.6-1.6,4.6c-1,0.9-2.4,1.1-3.8,1.1C183.5,58.5,182.2,58.2,181.1,57.4
                    ...
                    <c:when test="${currentNode.properties['buttonColor'].string eq 'coloredBackgroundWhite'}">
                        <svg version="1.1" id="Calque_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                             width="283.5px" height="82.2px" viewBox="0 0 283.5 82.2" style="enable-background:new 0 0 283.5 82.2;" xml:space="preserve">
                            <g>
                                <path style="fill:#034EA2;" d="M278,2H5.4C3,2,1.2,4,1.2,6.6v7.6c0,0,0,0,0,0v63.1c0,1.6,1,2.9,2.7,2.9h275.5
        ...
        <c:otherwise>
            <a href="#" style="color: transparent;" class="${cssClass}"
               onclick="connectToFranceConnect${fn:replace(currentNode.identifier, '-', '')}();return false;"
                    <c:if test="${not empty htmlId}"> id="${htmlId}"</c:if>
               <c:if test="${renderContext.editMode}">disabled</c:if> >
                <div class="joaFranceConnectConnector">
                    <c:choose>
                        <c:when test="${currentNode.properties['buttonColor'].string eq 'backgroundWhite'}">
                            <svg version="1.1" id="Calque_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                                 width="283.5px" height="82.2px" viewBox="0 0 283.5 82.2" style="enable-background:new 0 0 283.5 82.2;" xml:space="preserve">
