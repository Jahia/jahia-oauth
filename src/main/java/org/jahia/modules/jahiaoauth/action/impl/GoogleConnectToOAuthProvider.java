...
public class GoogleConnectToOAuthProvider extends ConnectToOAuthProvider {

    @Activate
    public void activate() {
        setName("connectToGoogleAction");
        setRequireAuthenticatedUser(false);
        setRequiredMethods("GET");
        setConnectorName("GoogleApi20");

        // Additional params for Google OAuth
        Map<String, String> params = new HashMap<>();
        params.put("access_type", "offline");  // Get refresh token
        params.put("prompt", "consent");  // Force reget refresh token
